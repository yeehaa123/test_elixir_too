defmodule TestElixirTooWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TestElixirTooWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TestElixirTooWeb.Gettext, "errors", msg, opts)
    end
  end
